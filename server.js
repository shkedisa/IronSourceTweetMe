...
app.get('/', function (req, res) {
    res.send('<html><body><h1>Welcome To TweetMe!</h1><h3>See the docs <a href ="https://github.com/shkedisa/IronSourceTweetMe/blob/master/README.md">here</a></h3></body></html>');
});